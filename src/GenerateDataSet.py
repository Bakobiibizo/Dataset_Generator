...
main_container.selectbox(
    "Select the Datatype You Want to Use:",
...
feedback_container.selectbox(
    "Please rate your experience with the dataset generator:", [1, 2, 3, 4, 5], index=0
)
